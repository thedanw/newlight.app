...
- `--dynamic-sidebar-width` CSS var drives the main-panel offset via #page-panel margin-right (5.3)
...
2 Account avatar placement and styling in sidebar footer (7.12) → deferred to Phase-1 (core auth)
