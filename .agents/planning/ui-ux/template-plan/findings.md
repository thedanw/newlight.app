...
- Stack/architecture: `ui-ux/decision.md` #1–11, #38, #42–61
...
- **Radius slider**: Park UI's own site ships `BorderRadiusSlider` — `Slider.Root min={0} max={radii.length-1}` + `Slider.Marks` with `radii = ['none','xs','sm','md','lg','xl','2xl']` → discrete 7-stop slider is native (decision.md #49).
